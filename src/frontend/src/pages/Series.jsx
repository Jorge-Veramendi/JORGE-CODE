...
function Series() {
  ...
  // SERIES POPULARES (para el banner)
  useEffect(() => {
    fetch(
      ...
      .catch((err) => console.error("Error al traer series populares:", err));
  }, []);
  ...
  useEffect(() => {
    fetch(
      ...
      .catch((err) => console.error("Error al traer airing today:", err));
  }, []);
  ...
  useEffect(() => {
    fetch(
      ...
      .catch((err) => console.error("Error al traer on the air:", err));
  }, []);
  ...
  return (
    <div className="bg-black text-white min-h-screen">
                ...
                {index === currentIndex && (
                  <div className="absolute bottom-24 left-12 z-30 max-w-2xl">
                    ...
                    <p className="text-gray-300 mb-6 text-lg max-w-xl line-clamp-3 drop-shadow-md">
                      {serie.overview || "Sin descripción disponible."}
                    </p>
      ...
      <Section title="Series mejor valoradas" data={topRatedSeries} id="topRated" />
